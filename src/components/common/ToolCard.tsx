    ...
    return (
        <Link to={link} className="block h-full no-underline">
            <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm hover:shadow-lg transition-all duration-300 relative overflow-hidden group h-full flex flex-col"
            >
                {hot && (
                ...
                <p className="text-gray-600 text-sm mb-6 line-clamp-2 h-10 flex-grow">
                    {description}
                </p>

                <div className="mt-auto">
                    <Button asChild className="w-full bg-gray-50 text-blue-600 hover:bg-blue-600 hover:text-white border border-blue-100 group-hover:border-transparent transition-all duration-300 cursor-pointer">
                        <div>
                            立即使用
