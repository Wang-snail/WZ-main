...
export default function HomePagePreview() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-slate-100 to-gray-50 relative overflow-hidden" style={{ fontFamily: "'Poppins', 'Noto Sans SC', sans-serif" }}>
      ...
      {/* Preview Note */}
      <div className="fixed bottom-4 right-4 backdrop-blur-xl bg-blue-50/80 border border-blue-200 rounded-2xl p-4 shadow-xl max-w-sm z-50">
        <div className="flex items-start">
          <Sparkles className="w-5 h-5 text-blue-600 mt-0.5 mr-2 flex-shrink-0" />
          <div>
            <p className="font-bold text-gray-800 mb-1">浅色玻璃拟态风格预览</p>
            <p className="text-sm text-gray-600">
              浅灰色背景 + 玻璃质感设计，清新优雅的视觉体验
            </p>
            <Link to="/" className="text-sm text-blue-600 font-medium underline mt-2 inline-block">
              返回当前首页
            </Link>
          </div>
        </div>
